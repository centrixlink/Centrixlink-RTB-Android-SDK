# CentrixlinkRTB Android SDK集成文档



### 版本支持及依赖

* CentrixlinkRTB 支持 Android 4.0以上系统版本（API LEVEL 14+）
* 第三方库依赖 Google Play Services (可选), libammsdk.jar	(可选)
* 申请：[App ID、App Key](https://www.centrixlink.com/register)

### 集成说明

### 1 将下载的CentrixlinkRTB SDK库文件拷贝到项目应用的libs目录下

```
  libs
	|-----CentrixlinkRTB[version].jar
...
<manifest>
    ...
    <!-- 广告 Activity -->
        <activity android:name="com.centrixlinkrtb.SDK.FullScreenADActivity"
